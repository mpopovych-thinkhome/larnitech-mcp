...
The card reader of the system's [intercom](intercom.md).
...
Whether card presentations, granted/denied results or card identifiers are
exposed when live is **unknown**. See
